...
$time = date("F d, Y");
$sql = mysqli_query($con,"SELECT title,content,id,email FROM content order by title desc");
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="container" >
	...
	<p style="font-family: 'Balsamiq Sans', cursive;font-size:35px;">General Discussion</p>
...
<br>
	<?php echo "<h6>".$row['email'].",</h6>";?>
		<?php echo '<span ><a  style="width:20%;background-color:#30438B;margin-right:80%;text-decoration:none;color:white;padding:8px;border-radius:4px;" href="details.php?id='.$row['id'].'">Details</a></span><br><span style="margin-left:85%;margin-top:-3%;"> '.$time.'</span>';?>
	</div>
<?php } ?>
</div>
</body>

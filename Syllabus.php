...
$sql = mysqli_query($con,"SELECT title,content,id,date,email FROM content where category='Syllabus' order by title desc");
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="container">
	...
	<p style="font-family: 'Balsamiq Sans', cursive;font-size:35px;">Syllabus</p>
